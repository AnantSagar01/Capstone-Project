...
To access Swagger UI (after running services):
  |    URL      |     🖼️ Screenshots                  |
  |-------------|------------------------------------|
  | Product Service: `http://localhost:8080/swagger-ui/index.html`    > 🔗 More details: [Product Service](https://github.com/AnantSagar01/Capstone-Project/blob/main/product-service-spring_boot/README.md)| ![Product Screenshot](https://github.com/user-attachments/assets/8401d348-39ea-4532-9729-403124c1aeee)  |
